microclimate <- function (micro) 
{
  ...
  drrlam <- a$drrlam
  srlam <- a$srlam
  metout.names <- c("DOY", "TIME", "TALOC", "TAREF", "RHLOC", 
                    "RH", "VLOC", "VREF", "SNOWMELT", "POOLDEP", "PCTWET", 
                    "ZEN", "SOLR", "TSKYC", "DEW", "FROST", "SNOWFALL", "SNOWDEP", 
                    "SNOWDENS")
  ...
  plant.names <- c("DOY", "TIME", "TRANS", "LPT", paste0("RPT", 
                                                         micro$DEP, "cm"))
  tcond.names <- c("DOY", "TIME", paste0("TC", micro$DEP, "cm"))
  spheat.names <- c("DOY", "TIME", paste0("SP", micro$DEP, 
                                          "cm"))
  ...
  snow.names <- c("DOY", "TIME", paste0("SN", c(1, 2, 3, 4, 
                                                5, 6, 7, 8, 9)))
  colnames(sunsnow) <- snow.names
  colnames(shdsnow) <- snow.names
  drlam.colnames <- c("DOY", "TIME", "290", "295", "300", "305", 
                      "310", "315", "320", "330", "340", "350", "360", "370", 
                      "380", "390", "400", "420", "440", "460", "480", "500", 
                      "520", "540", "560", "580", "600", "620", "640", "660", 
                      "680", "700", "720", "740", "760", "780", "800", "820", 
                      "840", "860", "880", "900", "920", "940", "960", "980", 
                      "1000", "1020", "1080", "1100", "1120", "1140", "1160", 
  ...
  return(list(metout = metout, soil = soil, shadmet = shadmet, 
              shadsoil = shadsoil, soilmoist = soilmoist, shadmoist = shadmoist, 
              humid = humid, shadhumid = shadhumid, soilpot = soilpot, 
              shadpot = shadpot, plant = plant, shadplant = shadplant, 
              sunsnow = sunsnow, shdsnow = shdsnow, tcond = tcond, 
              shadtcond = shadtcond, specheat = specheat, shadspecheat = shadspecheat, 
              densit = densit, shaddensit = shaddensit, drlam = drlam, 
