...
So far, no more than one clutch is represented per female per season in the dataset. I will therefore assume that...
\bigskip
...
All males are represented in all clutches by the same female throughout the same season.}
\end{center}
\end{minipage}
}
\end{center}
