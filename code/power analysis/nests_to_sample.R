  ...
  
{
  ...
  # pre-allocate females where all nests will be sampled
  ...
  # subset by breeding mode
  probs_subset <- subset(probs, 
                         Fertilization_mode == breeding, 
                         Sample_size == 32)
  
  # pull out probabilities
  probs <- probs_subset$Probability
